	...
	<div id="wrapper">
		<div id="three-column" class="container">
			<div class="title">
				...
				<%
					// 파라미터 정보 가져오기
				String loginform_id = request.getParameter("id");
				String loginform_pw = request.getParameter("password");
				String username = "";//유저이름 넣기
				int id_sucess =0;
				int pw_sucess =0;
				int login_sucess = 0;//로그인 성공여부 실패하면 0 성공하면 1
				...
				try {
					...
					while (rs.next()) {
						if (loginform_id.equals(rs.getString("member_id"))) {
							id_sucess = 1;
							if (loginform_pw.equals(rs.getString("member_pw"))) {
