	...
	<div id="wrapper">
		<div id="three-column" class="container">
			<div class="title">
				...
				String findform_id = request.getParameter("id");
				String userpw = "";//유저비밀번호 넣기
					...
					while (rs.next()) {
						...
						if (findform_name.equals(rs.getString("member_name"))) {
							...
							if (findform_email.equals(rs.getString("member_email"))) {
								...
								if (findform_id.equals(rs.getString("member_id"))) {
						...
						if (findform_email.equals(rs.getString("member_email"))) {
							...
							System.out.println(findform_name);
						}
						if (findform_id.equals(rs.getString("member_id"))) {
				...
				%>
						<script>
						alert(" 일치하는 정보가 없습니다.");
						location.href = 'find_pw_Form.jsp';
						</script>
				<%}else if(find_sucess==1){ %>
				<h3><%=findform_name %>님의 비밀번호는 <%= userpw %> 입니다. </h3>
				<%}%>
			</div>
			<!-- 		<div class="boxA">
